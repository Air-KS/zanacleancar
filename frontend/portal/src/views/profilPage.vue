	...
	<div class="page-container">
		...
		<div class="form-wrapper">
			<div>
				...
				<CardFidelity
  v-if="user.name && user.loyalty_points !== undefined"
  :stamps="7"
  :name="user.name"
...
/>
			...
			<section>
				<form class="fade-in-up" @submit.prevent="handleSave">
					...
					<div class="form-row">
						...
						<div class="form-group">
							<div class="forms-input-container">
								<input :class="{ 'has-value': user.name }" v-model="user.name" type="text"
									autocomplete="family-name" id="name" required placeholder="Ton nom de famille"
						...
						<div class="form-group">
							<div class="forms-input-container">
								<input :class="{ 'has-value': user.last_name }" v-model="user.last_name" type="text"
									autocomplete="given-name" id="last_name" placeholder="Ton prénom"
									class="forms-input-style" />
					...
					<div class="form-row">
						...
						<div class="form-group">
							<div class="forms-input-container">
								<input :class="{ 'has-value': user.date_of_birth }" v-model="user.date_of_birth"
									type="date" id="date_of_birth" class="forms-input-style" />
						...
						<div class="form-group">
							<div class="forms-input-container">
								<input :class="{ 'has-value': user.phone }" v-model="user.phone" type="tel"
									autocomplete="tel" id="phone" placeholder="Ton numéro de téléphone"
									class="forms-input-style" />
					...
					<div class="forms-input-container email-input">
						<input :class="{ 'has-value': user.email }" v-model="user.email" type="email"
			...
			<section>
				...
				<input type="text" v-model="deleteCompte" class="delete-input"
					placeholder="Tape la phrase exacte ici..." />
				<button @click.stop.prevent="handleDelete"
					:disabled="deleteCompte !== 'Je souhaite supprimer mon compte'" class="delete-button">
