    ...
    <div class="modal-content">
      ...
      <div class="image-wrapper modal-img-container">
        <transition :name="direction === 'left' ? 'slide-left' : 'slide-right'" mode="out-in">
          <img :key="currentIndex" :src="props.item.images[currentIndex]" class="modal-img" />
        </transition>
      </div>
...
const prevImage = () => {
  ...
  currentIndex.value = (currentIndex.value - 1 + props.item.images.length) % props.item.images.length
}
